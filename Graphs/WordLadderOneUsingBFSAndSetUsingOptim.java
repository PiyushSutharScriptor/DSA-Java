...
public class WordLadderOneUsingBFSAndSetUsingOptim{

    public static int findCount(List<String> originalList, String start, String end){

        Set<String> wordList = new HashSet<>();

        for(String se : originalList){
            wordList.add(se);
        }
